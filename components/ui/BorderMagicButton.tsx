...
export const BorderMagicButton = ({text, icon, position, handleClick, otherClasses}: {text: string, icon?: React.ReactNode, position?: string, handleClick?: () => void, otherClasses?: string}) => {
	return (
		<button onClick={handleClick} className="relative inline-flex w-full h-12 overflow-hidden rounded-lg p-[1px] md:w-60 md:mt-10 focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
